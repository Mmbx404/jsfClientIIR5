...
public class HelloWorldBean implements Serializable {
	...
	public void onUserChange () {
		System.out.println("This is the seelcted user from ajax : " + userEmail);
		this.simpleModel = new DefaultMapModel();
		for (User u : allUsers) {
			if (u.getEmail().equals(userEmail)) {
				for (SmartPhone sp : u.getSmartPhones()) {
					System.out.println("This is a smart Phone : " + sp.getName());
					for (Position p : sp.getPosition()) {
						System.out.println("This is a position : " + p.getLatitude() + " " + p.getLongitude());
	...
	public void onSubmit() {
		System.out.println("This is the selected Mounth " + mounth);
		
	}

	public void onMounthChange() {
		System.out.println("This is the selected Mounth Ajax Thingy " + mounth);
		if (mounth != null) {
			List<Number> values = new ArrayList<>();
			for (SmartPhone sp : allPhones) {
				int i = 0;
				for (Position p : sp.getPosition()) {
					System.out.println("this is a position " + p.getId() + " and this is its mounth " + p.getDate());
